/* Ruta: /tienda/faldas — datos REALES de GET /api/v1/catalog/products/.
  ...
  return (
    <section className="seccion">
      ...
      <ListadoProductos
        ...
        filtrosBase={{ family: FAMILIA_POR_RUTA['faldas'], line: 'pret_a_porter' }}
        seccionSinBackend={FAMILIA_POR_RUTA['faldas'] === null}
        propsCuadricula={{
