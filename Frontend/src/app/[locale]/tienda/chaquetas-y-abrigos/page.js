/* Ruta: /tienda/chaquetas-y-abrigos — datos REALES de GET /api/v1/catalog/products/.
  ...
  return (
    <section className="seccion">
      ...
      <ListadoProductos
        ...
        filtrosBase={{ family: FAMILIA_POR_RUTA['chaquetas-y-abrigos'], line: 'pret_a_porter' }}
        seccionSinBackend={FAMILIA_POR_RUTA['chaquetas-y-abrigos'] === null}
        propsCuadricula={{
